...
const ge = {
  ...
  signInBody:
    '\u10de\u10e0\u10dd\u10e4\u10d8\u10da\u10d8\u10e1 \u10e1\u10d0\u10dc\u10d0\u10ee\u10d0\u10d5\u10d0\u10d3 \u10d2\u10d7\u10ee\u10dd\u10d5\u10d7 \u10e8\u10d4\u10ee\u10d5\u10d8\u10d3\u10d4\u10d7 \u10e1\u10d8\u10e1\u10e2\u10d4\u10db\u10d0\u10e8\u10d8 \u10d0\u10dc \u10e8\u10d4\u10ee\u10db\u10d4\u10dc\u10d8\u10d7 \u10d0\u10dc\u10d2\u10d0\u10e0\u10d8\u10e8\u10d8 \u10db\u10d7\u10d0\u10d5\u10d0\u10e0\u10d8 \u10d2\u10d5\u10d4\u10e0\u10d3\u10d8\u10d3\u10d0\u10dc.',
  goHome: '\u10db\u10d7\u10d0\u10d5\u10d0\u10e0 \u10d2\u10d5\u10d4\u10e0\u10d3\u10d6\u10d4',
  email: '\u10d4\u10da-\u10e4\u10dd\u10e1\u10e2\u10d0',
  name: '\u10e1\u10d0\u10ee\u10d4\u10da\u10d8',
  promoTitle: '\u10de\u10e0\u10dd\u10db\u10dd \u10d9\u10dd\u10d3\u10d8',
  promoEmpty:
    '\u10de\u10e0\u10dd\u10db\u10dd \u10d9\u10dd\u10d3\u10d8 \u10ef\u10d4\u10e0 \u10d0\u10e0 \u10d2\u10d0\u10ee\u10d5\u10d7. \u10d3\u10d0\u10d0\u10e1\u10e0\u10e3\u10da\u10d4\u10d7 AylopetAI \u10e9\u10d0\u10d7\u10d8 \u10d0\u10dc \u10e0\u10d4\u10d2\u10d8\u10e1\u10e2\u10e0\u10d0\u10ea\u10d8\u10d0 \u10e9\u10d0\u10d7\u10d8\u10d3\u10d0\u10dc.',
  chatCta: 'AylopetAI \u10e9\u10d0\u10d7\u10d8',
  signOut: '\u10d2\u10d0\u10e1\u10d5\u10da\u10d0',
  supabaseWarn:
    'Supabase \u10d0\u10e0 \u10d0\u10e0\u10d8\u10e1 \u10d9\u10dd\u10dc\u10e4\u10d8\u10d2\u10e3\u10e0\u10d8\u10e0\u10dd\u10d1\u10e3\u10da\u10d8. \u10e8\u10d4\u10d0\u10db\u10dd\u10ec\u10db\u10dd\u10d7 .env.local (NEXT_PUBLIC_SUPABASE_URL \u10d3\u10d0 NEXT_PUBLIC_SUPABASE_ANON_KEY).',
};
...
const en = {
  ...
  signOut: 'Sign out',
  supabaseWarn:
    'Supabase is not configured. Check .env.local for NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY.',
};

const copyLiteral = `const copy: Record<Lang, Record<string, string>> = {
  GE: ${JSON.stringify(ge, null, 2).replace(/\n/g, '\n  ')},
...
const out = path.join(__dirname, '..', 'app', 'profile', 'page.tsx');
